...
wordLabel = tk.Label(window1, text="dfvx", font=("Arial", 27))
wordLabel.place(x=200, y=200, anchor='center')

wpmLabel = tk.Label(window1, text="WPM: ", font=("Arial", 18))
wpmLabel.place(x=20, y=20)
window1.update()


numEntry = tk.Entry(window1, width='10')
...
startButton = tk.Button(window1, text="Start", bg="white", fg="green", command=startProg, padx=5, pady=5)
startButton.place(x=numEntry.winfo_width() + numEntry.winfo_rootx(), y=20)
window1.update()

resumeButton = tk.Button(window1, text="Resume", bg="white", fg="green", command=startProg, padx=5, pady=5, state=tk.DISABLED)
resumeButton.place(x=startButton.winfo_width() + startButton.winfo_rootx(), y=20)
window1.update()

pauseButton = tk.Button(window1, text="Pause", bg="white", fg="red", command=startProg, padx=5, pady=5, state=tk.DISABLED)
